...
if (!isset($_SESSION["estoy"]) || $_SESSION["estoy"] !== true) {
  ...
  redireccionConContador("No estas LOGIN, vamos a ello", 3, "/practica3.5.2/login.html");
} else {
  //Redirigimos a la página protegida de acceso
  redireccionConContador("Has iniciado sesión correctamente", 3, "/practica3.5.2/protegida.php");
}
